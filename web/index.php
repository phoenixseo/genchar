          ...
          <div class="col-span-2">
            <nav class="flex space-x-4">
              ...
              for( $i = 0; $i < sizeof($classes); $i++ ) {
                echo '<a href="syllables.php?class=' . $classes[$i] . '" class="text-white text-sm font-medium rounded-md bg-white bg-opacity-0 px-3 py-2 hover:bg-opacity-10">' . ucfirst($classes[$i]) . ' </a>';
              }
              ?>
            </nav>
          </div>
                ...
                for( $i = 0; $i < sizeof($classes); $i++ ) {
                  echo '<div class="ring-2">';
                    echo '<div class="flex items-center not-prose bg-gray-200">';
                      echo $g->get_class_icon($classes[$i]);
                      echo '<span class="ml-2 text-2xl">' . ucfirst($classes[$i]) . '</span>';
                    echo '</div>';
                    echo '<div class="not-prose p-2">';
                      echo '<p class="text-5xl font-mono">'. $g->char_name( $classes[$i], 3 ) . '</p>';
                    echo '</div>';
                  echo '</div>';
                }
